...
class RoutesInsertView(LoginRequiredMixin, generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            # ==========================================
            # 2.1 CRITICAL SECURITY FIX: Financial Manipulation Prevention
            # ==========================================
            if price is not None and float(price) < 0:
                context['error'] = 'Financial Integrity Error: Negative tariff values are strictly prohibited.'
                return render(request, 'users/route.html', context)
...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        # --- 2. ACCOUNT LOCKOUT CHECK (3 FAILED LOGINS THRESHOLD) ---
